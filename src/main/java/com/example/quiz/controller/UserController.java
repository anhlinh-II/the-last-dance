...
public class UserController extends BaseController<User, Long, UserRequest, UserResponse, UserView> {
    ...
    public UserController(
            BaseService<User, Long, UserRequest, UserResponse, UserView> service,
    ...
    public ResponseEntity<ApiResponse<LoginResponse>> login(@Valid @RequestBody LoginRequest loginRequest) {
        ...
        String refresh_token = securityUtils.createRefreshToken(loginRequest.getUsername(), apiResponse.getResult());
    ...
    public ResponseEntity<ApiResponse<LoginResponse>> getRefreshToken(
        ...
        ApiResponse<LoginResponse> apiResponse = userService.getRefreshToken(refresh_token, message);
    ...
    public ResponseEntity<ApiResponse<Void>> logout() {
        ...
        ApiResponse<Void> apiResponse = userService.logout(emailUsernamePhone);
    ...
    public ApiResponse<Map<String, String>> getOAuth2Url() {
        ...
        result.put("instruction", "Copy this URL to browser, authorize, then copy the 'code' parameter from redirect URL to test OAuth2 callback endpoint");
